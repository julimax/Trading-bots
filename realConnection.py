...
def datos():
	...
	parametroLong = (Ema9Last+(Ema9Last*0.00038))
	parametroShort = (Ema25Last-(Ema25Last*0.00038))
...
def signal():
	...
	if tradeS() == False and Ema9Last < Ema25Last and price > parametroShort:
		open_short()
		print('Open Short')
	if tradeL() == True and (rsiLast > 79 or Ema9Last < Ema25Last):
		close_long()
		print('Close Long')
	if tradeS() == True and (rsiLast < 21 or Ema9Last > Ema25Last):
		close_short()
		print('Close Short')
